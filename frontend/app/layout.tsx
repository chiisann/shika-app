...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className="flex flex-col bg-custom-image font-sans min-h-screen">
        {/* Header */}
        ...
        {children}
        {/* Footer */}
        <footer className="text-white font-mono mt-auto">
          <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <hr className="mb-6 sm:mx-auto lg:my-8" />
            <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm  sm:text-center dark:text-gray-400">
                © 2024 Chii560. All Rights Reserved.
              </span>
